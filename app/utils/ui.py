...
def top_nav():
    ...
    """, unsafe_allow_html=True)
    logo_path = Path(__file__).resolve().parents[2] / "assets" / "eda" / "logo.png"
    ...
    with col1:
        st.markdown(
            f'<img src="data:image/png;base64,{b64}" height="100">',
            unsafe_allow_html=True
        )
...
def model_tooltip(model_name: str, color: str = "#2563cb"):
